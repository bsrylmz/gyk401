...
import com.example.healthapp.adapters.DietListAdapter;
...
public class DietListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ListView listViewFood = (ListView)view.findViewById(R.id.listViewFood);
        DietListAdapter dietListAdapter = new DietListAdapter(getLayoutInflater(), dietList);
        listViewFood.setAdapter(dietListAdapter);
        return view;
    }
